...
from workers.core_ia.services_agents.prompts_agents import prompt_register
from workers.core_ia.services_agents.tool_reset import REROUTE_COMPLETED_STATUS
from workers.core_ia.services_agents.tools_schemas import REGISTRATION_TOOL_SCHEMA
...
class Agent_register():
    ...
    def generate_register(self, history_str: str, chat_id: str) -> str:
        ...
        """
        contexto_dinamico = f"""Você é o Assistente de Cadastro da {CLINICA_NOME}, COLETA DE NOME E REGISTRO DE USUARIO**.
# DADOS PARA O REGISTRO:
- Clínica: {CLINICA_NOME}
- E-mail para Exclusão de Dados: {CLINICA_EMAIL}
"""
        mensagens = [
            {
                "role": "system",
