...
# Força o Django a usar o seu novo portal secreto para o login
LOGIN_URL = '/portal-secreto-dev-m/login/'

# Para onde o usuário vai depois que logar com sucesso
LOGIN_REDIRECT_URL = '/control-quiro/'
